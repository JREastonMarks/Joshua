...
left_final_middle = abs(1 - hrr.cosine_similarity(observation_left_final, observation_left_middle))
left_middle_start = abs(1 - hrr.cosine_similarity(observation_left_middle, observation_left_start))

left_right_start = abs(1 - hrr.cosine_similarity(observation_left_start, observation_right_start))

right_middle_start = abs(1 - hrr.cosine_similarity(observation_right_start, observation_right_middle))
right_final_middle = abs(1 - hrr.cosine_similarity(observation_right_middle, observation_right_final))
